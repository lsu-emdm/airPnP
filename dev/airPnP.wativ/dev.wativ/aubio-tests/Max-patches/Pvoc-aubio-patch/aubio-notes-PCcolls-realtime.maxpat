...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 17356.894024592256756, "ms" ],
						"loopstart" : [ 13566.258972799736512, "ms" ],
						"mode" : "basic",
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 13763.605918403534815, "ms" ],
						"loopstart" : [ 13566.258972799736512, "ms" ],
						"mode" : "basic",
						"originallength" : [ 16799.99969172058627, "ticks" ],
						"originaltempo" : 120.0,
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 72.723636746406555, 536.233649165954375, 228.44727349281311, 132.333977787170625 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"depth" : 1,
					"id" : "obj-32",
					"items" : [ "aubio-cut-midi-map.maxpat", ",", "aubio-notes-PCcolls-3Bpats.maxpat", ",", "aubio-notes-PCcolls-readMidi(encap).maxpat", ",", "aubio.cmd.js", ",", "aubio.cmd.notes.js", ",", "aubio_notes_data.txt", ",", "aubio_notes_data1038.txt", ",", "aubio_notes_data115.txt", ",", "aubio_notes_data1586197486219.txt ", ",", "aubio_notes_data20200406134259.txt ", ",", "aubio_notes_data20200412211514.txt ", ",", "aubio_notes_data20200412212538.txt ", ",", "aubio_notes_data20200412213043.txt ", ",", "aubio_notes_data20200412213058.txt ", ",", "aubio_notes_data20200412213138.txt ", ",", "aubio_notes_data20200412213458.txt ", ",", "aubio_notes_data20200412213713.txt ", ",", "aubio_notes_data20200412213742.txt ", ",", "aubio_notes_data20200412214022.txt ", ",", "aubio_notes_data20204613382.txt ", ",", "aubio_notes_data2128.txt ", ",", "aubio_notes_data2137.txt ", ",", "aubio_notes_data_sans.txt", ",", "aubio_pitch_data1000.txt", ",", "buffer-midimap-tune pvoc.maxpat", ",", "dip believer.aif", ",", "good old days.aif", ",", "good_old_days.aif", ",", "mypvocrapid~.maxpat", ",", "mypvocsimple~.maxpat", ",", "notes.sh", ",", "package.json", ",", "PCcoll-bpatch.maxpat", ",", "PCcollections-bPatcher.maxpat", ",", "praying about it!.aif", ",", "Sans.wav", ",", "shell.maxhelp", ",", "shell.mxe", ",", "shell.mxe64", ",", "shell.mxo", ",", "Star-spangled-melody.mid" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 183.556942343711853, 129.167445559119642, 47.0, 23.0 ],
					"text" : "query"
				}
