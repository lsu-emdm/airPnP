...
Max.addHandler("pitch", () => {
  ...
  Max.addHandler('notes', (filename) => {
    ...
    cmd.get(`
    /Library/Frameworks/Python.framework/Versions/3.6/bin/aubio notes /Users/wativ/Desktop/airPnP.wativ.offline/dev/wativ/aubio-tests/${filename} > aubio_notes_data_${filename}_${timestamp}.txt 
    `,
    (err, data, stderr) => {
        console.log('The File is : ',data);
        console.log('Error', err);
