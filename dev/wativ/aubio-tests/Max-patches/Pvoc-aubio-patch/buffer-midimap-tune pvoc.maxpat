...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 506.75, 486.0, 41.0, 22.0 ],
					"text" : "sel 52"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 597.0, 563.567003877486968, 150.0, 74.0 ],
					"text" : "join coll of MIDI # 52:\nnew sequential num\nMIDI #\nstart\nend"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 507.0, 582.0, 50.5, 22.0 ],
					"text" : "join 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 538.25, 518.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 506.75, 548.033501938743484, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 506.75, 617.067003877486968, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 4034.444584037956702, "ms" ],
						"loopstart" : [ 3993.809661997050171, "ms" ],
						"mode" : "basic",
...
,
									"fileref" : 									{
										...
										"filepos" : -1,
										"snapshotfileid" : "c7cdc9b38ccb92b9e8b976d725cec85e"
									}
...
, 			{
				...
				"bootpath" : "~/Documents/GitHub/airPnP/dev/wativ/aubio-tests/Max-patches/Pvoc-aubio-patch",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
