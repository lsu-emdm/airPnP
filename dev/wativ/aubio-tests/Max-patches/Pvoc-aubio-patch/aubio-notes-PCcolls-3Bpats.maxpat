...
,
		"classnamespace" : "box",
		"rect" : [ 2238.0, 100.0, 1332.0, 965.0 ],
		"bglocked" : 0,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.69727349281311, 275.00160054130447, 68.0, 22.0 ],
					"text" : "append .txt"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 190.69727349281311, 248.000800270652235, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 555.75, 81.0, 413.0, 159.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 842.5, 301.534125014381516, 47.0, 22.0 ],
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 724.75, 301.534125014381516, 47.0, 22.0 ],
					"text" : "* 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 485.5, 254.534125014381516, 67.0, 23.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.5, 279.534125014381516, 55.0, 23.0 ],
					"text" : "set TBD"
				}
...
,
					"patching_rect" : [ 465.0, 374.067626953125, 21.0, 79.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 921.5, 326.067626953125, 61.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select all"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 817.75, 326.067626953125, 94.0, 20.0 ],
					"style" : "helpfile_label",
					"text" : "select end ms"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 700.0, 326.067626953125, 94.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 573.75, 326.067626953125, 111.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 461.0, 326.067626953125, 101.0, 20.0 ],
					"style" : "helpfile_label",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 923.5, 346.067626953125, 57.0, 23.0 ],
					"text" : "0 -1 0 -1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 779.5, 471.067626953125, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 683.5, 471.067626953125, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 587.5, 471.067626953125, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 491.5, 471.067626953125, 40.0, 21.0 ],
					"text" : "set $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 485.5, 301.534125014381516, 40.0, 23.0 ],
					"text" : "undo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 838.75, 346.067626953125, 81.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 721.0, 346.067626953125, 94.75, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 603.25, 346.067626953125, 105.386032104492188, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 485.5, 346.067626953125, 52.0, 23.0 ],
					"triscale" : 0.9
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 485.5, 375.067626953125, 490.0, 93.0 ],
					"setmode" : 1,
					"ticks" : 8,
					"vlabels" : 1
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 933.0, 372.067626953125, 966.0, 372.067626953125 ],
					"source" : [ "obj-95", 0 ]
				}
