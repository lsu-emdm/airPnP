...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "", "int", "", "" ],
					"patching_rect" : [ 35.543693621953338, 518.233649165954375, 228.44727349281311, 132.333977787170625 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 259.644600927829742, 756.833354711532593, 150.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 24.977935791015625, 756.833354711532593, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 50.977935791015625, 756.833354711532593, 41.0, 32.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ -8.833388805389404, 388.167445559119642, 37.0, 33.0 ],
					"text" : "MIDI note"
				}
...
,
													"fileref" : 													{
														...
														"filepos" : -1,
														"snapshotfileid" : "ccbb90d0d91ad37712bbf39ef16483be"
													}
...
,
					"patching_rect" : [ 50.977935791015625, 800.833354772789107, 115.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"saved_object_attributes" : 					{
						...
						"followglobaltempo" : 0,
						"formantcorrection" : 0,
						"loopend" : [ 10919.161375540090376, "ms" ],
						"loopstart" : [ 10884.331442362170492, "ms" ],
						"mode" : "basic",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ -16.333388805389404, 362.467298331908751, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 104.311241388320923, 835.0, 27.0, 57.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 67.311241388320923, 835.0, 27.0, 57.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 74.311241388320923, 919.833354711532593, 45.0, 45.0 ]
				}
