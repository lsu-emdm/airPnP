...
Max.addHandler("pitch", () => {
    cmd.get(`
    /Library/Frameworks/Python.framework/Versions/3.6/bin/aubio pitch /Users/wativ/Desktop/airPnP.wativ.offline/dev/wativ/aubio-tests/PianoInsideRev4.wav > aubio_pitch_data.txt
    `,
    (err, data, stderr) => {
        console.log('The File is : ',data);
